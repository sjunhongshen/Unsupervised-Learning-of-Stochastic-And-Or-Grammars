...
namespace AOG_LIB
{
    ...
    class AOG_Edge
    {
         ...
         * @param weight: the weight to be set to.
         * @throw if the given weight is less than zero, throw an exception.
         * @returns void
         */
    ...
    public:
         ...
         * 
         * @param weight that associate with current edge
         */ 
        explicit AOG_Edge(double);
        /**
         * return the current weight of the edge.
         * 
         * @returns current weight on this edge
         */ 
