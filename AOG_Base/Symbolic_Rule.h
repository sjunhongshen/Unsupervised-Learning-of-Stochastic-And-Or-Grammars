...
namespace AOG_LIB
{
    ...
    public:
         ...
         * @param resulting symbolic states
         */
        Symbolic_Rule(const Symbolic_State<StateType> &,
                      const std::vector<Symbolic_State<StateType> >&);
        /**
         * Get the source symbolic state of the rule
         * 
         * @returns the source symbolic state of the rule 
         */
        const Symbolic_State<StateType>& GetSource() const;
        /**
         * Get the rule's results
         * 
         * @returns the rule's results
         */
         ...
         * @param rhs: the other symbolic rule to be compared with
         * @returns true if the source and resulting symbolic states of the two rules are all the same
         */
